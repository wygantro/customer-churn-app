                          ...
                          fluidRow(
                            column(width = 8, show_col_types = FALSE,
                                   ...
                                   fluidRow(
                                     column(width = 5,
                                            ...
                                            h5("Total Customer Count: ",
                                               verbatimTextOutput("total")),
                                            h5("Percent of Total: ",
                                               verbatimTextOutput("total_perc")),
                                            box(width = NULL,
                                                solidHeader = TRUE,
                                                status = "primary",
                                                color = "#286192",
                            ...
                            column(width = 4,
                                   ...
                                   fluidRow(
                                     column(width = 12,
                                            show_col_types = FALSE,
                                            h5("Customer Stayed Count: ",
                                               verbatimTextOutput("stayed")
                                               ),
                                            h5("Percent of Total: ",
                                               verbatimTextOutput("stayed_perc")
                                               )
                                            ),
                                     column(width = 12,
                                            show_col_types = FALSE,
                                            h5("Total Churn Count: ",
                                               verbatimTextOutput("churn")),
                                            h5("Percent of Total: ",
                                               verbatimTextOutput("churn_perc")
                                               )
                                            )
                                     )
                                   )
